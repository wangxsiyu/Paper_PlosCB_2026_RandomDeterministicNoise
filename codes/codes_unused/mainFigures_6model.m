...
%% codes for 6 model posterior checks (newer versions in file main_7_6model_posterior_checks_Fig7_S17_S18.m)
%% load simulations
...
plt = EEplot_2noise_pinconsistent(plt, sgp.modelE, '_byR', '_byR', '');
plt.update("S3_fig")
